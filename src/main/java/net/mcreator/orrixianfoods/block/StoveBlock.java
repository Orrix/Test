...
public class StoveBlock extends OrrixianfoodsModElements.ModElement {
	@ObjectHolder("orrixianfoods:stove")
	public static final Block block = null;
	@ObjectHolder("orrixianfoods:stove")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public StoveBlock(OrrixianfoodsModElements instance) {
		super(instance, 11);

...
package net.mcreator.orrixianfoods.block;
...
import net.mcreator.orrixianfoods.item.TomatoItem;
...
public class TomatoPlantBlock extends OrrixianfoodsModElements.ModElement {
	@ObjectHolder("orrixianfoods:tomato_plant")
	public static final Block block = null;
	public TomatoPlantBlock(OrrixianfoodsModElements instance) {
		super(instance, 14);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("orrixianfoods:tomato_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
